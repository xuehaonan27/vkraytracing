#ifndef BASE_SWAP_CHAIN_HPP
#define BASE_SWAP_CHAIN_HPP
...
class SwapChain final {
  ...
  private:
    ...
    static VkExtent2D
    ChooseSwapExtent(const Window& window, const VkSurfaceCapabilitiesKHR& capabilities);
