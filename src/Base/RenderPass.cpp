...
RenderPass::RenderPass(
    ...
    colorAttachment.initialLayout = colorBufferLoadOp == VK_ATTACHMENT_LOAD_OP_CLEAR
    ...
    depthAttachment.initialLayout = depthBufferLoadOp == VK_ATTACHMENT_LOAD_OP_CLEAR
        ? VK_IMAGE_LAYOUT_UNDEFINED
    ...
    Check(
        vkCreateRenderPass(swapChain_.Device().Handle(), &renderPassInfo, nullptr, &renderPass_),
        "create render pass"
    );
}
