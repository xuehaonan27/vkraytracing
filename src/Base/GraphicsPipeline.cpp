...
GraphicsPipeline::GraphicsPipeline(
    ...
    const auto bindingDescription = RayTrace::Vertex::GetBindingDescription();
    const auto attributeDescriptions = RayTrace::Vertex::GetAttributeDescriptions();
    ...
    descriptorSetManager_.reset(
        new DescriptorSetManager(device, descriptorBindings, uniformBuffers.size())
    );
    ...
    pipelineLayout_.reset(
        new class PipelineLayout(device, descriptorSetManager_->DescriptorSetLayout())
    );
    ...
    Check(
        vkCreateGraphicsPipelines(device.Handle(), nullptr, 1, &pipelineInfo, nullptr, &pipeline_),
