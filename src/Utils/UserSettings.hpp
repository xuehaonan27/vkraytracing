#ifndef UTILS_USER_SETTINGS_HPP
#define UTILS_USER_SETTINGS_HPP
...
struct UserSettings final {
    ...
    bool RequiresAccumulationReset(const UserSettings& prev) const {
        return IsRayTraced != prev.IsRayTraced || AccumulateRays != prev.AccumulateRays
            || NumberOfBounces != prev.NumberOfBounces || FieldOfView != prev.FieldOfView
            || Aperture != prev.Aperture || FocusDistance != prev.FocusDistance;
    }
};

#endif // UTILS_USER_SETTINGS_HPP
